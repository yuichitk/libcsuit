...
#define SUIT_SUCCESS                        0 // success

#define SUIT_DECODE_MODE_STRICT                 0 // 0b00000000 - abort immediately on any error
#define SUIT_DECODE_MODE_SKIP_SIGN_FAILURE      1 // 0b00000001 - through but report on verification failure
#define SUIT_DECODE_MODE_SKIP_UNKNOWN_ELEMENT   2 // 0b00000010 - through unknown or unimplemented element(key or value)
#define SUIT_DECODE_MODE_PRESERVE_ON_ERROR      4 // 0b00000100 - preserve successfully parsed elements on error in Map/Array
#define SUIT_DECODE_MODE_SKIP_ANY_ERROR       255 // 0b11111111 - through excepting fatal error
