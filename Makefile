...
INC					= -I ./inc
SRCS				= src/suit_common.c src/suit_manifest_decode.c src/suit_manifest_encode.c src/suit_manifest_print.c src/suit_cose.c src/suit_digest.c
PUBLIC_INTERFACE	= inc/csuit.h inc/suit_common.h inc/suit_manifest_data.h inc/suit_manifest_print.h inc/suit_cose.h inc/suit_digest.h
OBJDIR				= ./obj
